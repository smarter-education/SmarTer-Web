                ...
                <main className="bg-[#e6e5e5] w-screen h-screen overflow-hidden">
                    <div className="p-[17px]">
                        <div className="flex gap-5">
                            <div className="w-[550px] h-[530px] bg-smarter1 border-2 border-solid border-gray-300 p-3 rounded-lg overflow-y-scroll  ">
                                <h6 className="text-black font-bold mb-1">
                                    Kelas Saya
                                </h6>
                                <div className="border-t border border-gray-300 mb-3"></div>
                                <div className="flex flex-col gap-3 h-screen">
                                    <div className="bg-white w-[510px] rounded-lg">
                                        <div className="p-3">
                            ...
                            <div>
                                <div className="w-[520px] h-[210px] bg-smarter1 mb-2 border-2 border-solid border-gray-300 p-3 rounded-lg">
                                    ...
                                    <div className="">
                                        <div className="flex flex-wrap items-center justify-around ">
                                            <div className="bg-white w-[160px] h-[60px] rounded-lg flex justify-center items-center">
                                ...
                                <div className="w-[520px]  bg-smarter1 mb-2 border-2 border-solid border-gray-300 p-3 rounded-lg overflow-y-scroll">
                                    <h6 className="text-black font-bold mb-1">
                                        Riwayat Transaksi
                                    </h6>
                                    <div className="border-t border border-gray-300 mb-3"></div>
                                    {/* tabel start */}
                                    <div class="overflow-x-auto h-[240px] ">
